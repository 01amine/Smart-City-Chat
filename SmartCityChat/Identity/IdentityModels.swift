...
/// # IdentityModels
///
/// Defines SmartCityChat's innovative three-layer identity model that balances
/// privacy, security, and usability in a decentralized mesh network.
///
/// ## Overview
/// SmartCityChat's identity system separates concerns across three distinct layers:
