...
///
/// # SmartCityChatProtocol
///
/// Defines the application-layer protocol for SmartCityChat mesh networking, including
/// message types, packet structures, and encoding/decoding logic.
///
/// ## Overview
/// SmartCityChatProtocol implements a binary protocol optimized for Bluetooth LE's
...
/// Simplified SmartCityChat protocol message types.
...
protocol SmartCityChatDelegate: AnyObject {
...
extension SmartCityChatDelegate {
    func isFavorite(fingerprint: String) -> Bool {
        return false
    }
