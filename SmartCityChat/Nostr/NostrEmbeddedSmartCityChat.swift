...
// MARK: - SmartCityChat-over-Nostr Adapter

struct NostrEmbeddedSmartCityChat {
    /// Build a `SmartCityChat1:` base64url-encoded SmartCityChat packet carrying a private message for Nostr DMs.
    static func encodePMForNostr(content: String, messageID: String, recipientPeerID: PeerID, senderPeerID: PeerID) -> String? {
        ...
        return "SmartCityChat1:" + base64URLEncode(data)
    }

    /// Build a `SmartCityChat1:` base64url-encoded SmartCityChat packet carrying a delivery/read ack for Nostr DMs.
    ...
    /// Build a `SmartCityChat1:` ACK (delivered/read) without an embedded recipient peer ID (geohash DMs).
    ...
    /// Build a `SmartCityChat1:` payload without an embedded recipient peer ID (used for geohash DMs).
