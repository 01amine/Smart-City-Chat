...
/// Represents a peer in the SmartCityChat network with all associated metadata
struct SmartCityChatPeer: Equatable {
    ...
    static func == (lhs: SmartCityChatPeer, rhs: SmartCityChatPeer) -> Bool {
