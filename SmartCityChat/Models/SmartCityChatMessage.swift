...
/// Represents a user-visible message in the SmartCityChat system.
/// Handles both broadcast messages and private encrypted messages,
/// with support for mentions, replies, and delivery tracking.
/// - Note: This is the primary data model for chat messages
final class SmartCityChatMessage: Codable {
    let id: String
    let sender: String
    let content: String
    let timestamp: Date
...
extension SmartCityChatMessage: Equatable {
    static func == (lhs: SmartCityChatMessage, rhs: SmartCityChatMessage) -> Bool {
...
extension Array where Element == SmartCityChatMessage {
    ...
    func cleanedAndDeduped() -> [Element] {
        ...
        var seen = Set<String>()
        var dedup: [SmartCityChatMessage] = []
