...
final class PrivateChatManager: ObservableObject {
    @Published var privateChats: [PeerID: [SmartCityChatMessage]] = [:]
            ...
            if noiseKeyHex != peerID, let nostrMessages = privateChats[noiseKeyHex], !nostrMessages.isEmpty {
                ...
                for message in nostrMessages {
                    if !existingMessageIds.contains(message.id) {
                        ...
                        let updatedMessage = SmartCityChatMessage(
                            id: message.id,
    ...
    func sanitizeChat(for peerID: PeerID) {
        ...
        var deduped: [SmartCityChatMessage] = []
    ...
    private func sendReadReceipt(for message: SmartCityChatMessage) {
