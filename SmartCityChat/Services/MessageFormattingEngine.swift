...
final class MessageFormattingEngine {
    ...
    static func formatMessage(
        _ message: SmartCityChatMessage,
    ...
    private static func formatSystemMessage(_ message: SmartCityChatMessage, isDark: Bool) -> AttributedString {
        var result = AttributedString()
    ...
    private static func formatMatch(_ text: String, type: MatchType, baseColor: Color, isSelf: Bool) -> AttributedString {
        ...
        case .mention:
            ...
            mentionStyle.font = .SmartCityChatSystem(size: 14, weight: .semibold, design: .monospaced)
        ...
        case .url:
            ...
            style.font = .SmartCityChatSystem(size: 14, design: .monospaced)
    ...
    private static func formatTimestamp(_ timestamp: String) -> AttributedString {
        ...
        style.font = .SmartCityChatSystem(size: 10, design: .monospaced)
