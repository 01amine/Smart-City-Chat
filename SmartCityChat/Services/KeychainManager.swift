...
final class KeychainManager: KeychainManagerProtocol {
    ...
    private let service = SmartCityChatApp.bundleID
    private let appGroup = "group.\(SmartCityChatApp.bundleID)"
    ...
    private func saveDataWithResult(_ data: Data, forKey key: String, retryCount: Int = 2) -> KeychainSaveResult {
        ...
        var base: [String: Any] = [
            ...
            kSecAttrLabel as String: "SmartCityChat-\(key)"
        ]
        #if os(macOS)
        ...
        if searchStatus == errSecSuccess, let items = result as? [[String: Any]] {
            for item in items {
                ...
                if accessGroup == appGroup {
                    ...
                    "com.SmartCityChat.passwords",
                    "com.SmartCityChat.deviceidentity",
                    "com.SmartCityChat.noise.identity",
                    "chat.SmartCityChat.passwords",
                    "SmartCityChat.keychain",
                    "SmartCityChat",
                    "com.SmartCityChat"
                ].contains(service) {
                    shouldDelete = true
