...
final class VerificationService {
    ...
    struct VerificationQR: Codable {
        ...
        static let context = "SmartCityChat-verify-v1"
        ...
        static func fromURL(_ url: URL) -> VerificationQR? {
            guard url.scheme == "SmartCityChat", url.host == "verify",
    ...
    func buildVerifyResponse(noiseKeyHex: String, nonceA: Data) -> Data? {
        ...
        var msg = Data("SmartCityChat-verify-resp-v1".utf8)
