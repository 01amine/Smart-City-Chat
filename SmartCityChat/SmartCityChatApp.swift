...
@main
struct SmartCityChatApp: App {
    static let bundleID = Bundle.main.bundleIdentifier ?? "chat.SmartCityChat"
    ...
    private func handleURL(_ url: URL) {
        if url.scheme == "SmartCityChat" && url.host == "share" {
    ...
    private func checkForSharedContent() {
        ...
        guard let userDefaults = UserDefaults(suiteName: SmartCityChatApp.groupID) else {
            return
        }
