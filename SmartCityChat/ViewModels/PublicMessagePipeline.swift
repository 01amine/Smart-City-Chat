...
final class PublicMessagePipeline {
    ...
    private var buffer: [SmartCityChatMessage] = []
    ...
    func enqueue(_ message: SmartCityChatMessage) {
...
private extension PublicMessagePipeline {
    ...
    func flushBuffer() {
        ...
        var pending: [(message: SmartCityChatMessage, contentKey: String)] = []
    ...
    func insertionIndex(for timestamp: Date, in messages: [SmartCityChatMessage]) -> Int {
        var low = 0
