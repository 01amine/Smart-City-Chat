...
extension ChatViewModel {
    ...
    func sendVoiceNote(at url: URL) {
        ...
        Task.detached(priority: .userInitiated) { [weak self] in
            ...
            do {
                ...
                let packet = SmartCityChatFilePacket(
    ...
    @MainActor
    func enqueueMediaMessage(content: String, targetPeer: PeerID?) -> SmartCityChatMessage {
        let timestamp = Date()
        let message: SmartCityChatMessage
    ...
    func cleanupLocalFile(forMessage message: SmartCityChatMessage) {
    ...
    @MainActor
    func handlePrivateMessage(_ message: SmartCityChatMessage) {
    ...
    func addMessageToPrivateChatsIfNeeded(_ message: SmartCityChatMessage, targetPeerID: PeerID) {
    ...
    @MainActor
    func mirrorToEphemeralIfNeeded(_ message: SmartCityChatMessage, targetPeerID: PeerID, key: Data?) {
        guard let key,
    ...
    @MainActor
    func handleViewingThisChat(_ message: SmartCityChatMessage, targetPeerID: PeerID, key: Data?, senderPubkey: String) {
    ...
    func processActionMessage(_ message: SmartCityChatMessage) -> SmartCityChatMessage {
    ...
    func migratePrivateChatsIfNeeded(for peerID: PeerID, senderNickname: String) {
        ...
        if privateChats[peerID] == nil || privateChats[peerID]?.isEmpty == true {
            var migratedMessages: [SmartCityChatMessage] = []
    ...
    @MainActor
    func isMessageBlocked(_ message: SmartCityChatMessage) -> Bool {
