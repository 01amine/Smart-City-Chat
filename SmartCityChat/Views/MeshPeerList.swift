...
struct MeshPeerList: View {
    ...
    var body: some View {
        ...
        let mapped: [(peer: SmartCityChatPeer, isMe: Bool, hasUnread: Bool, enc: EncryptionStatus)] = viewModel.allPeers.map { peer in
        ...
        let peers: [(peer: SmartCityChatPeer, isMe: Bool, hasUnread: Bool, enc: EncryptionStatus)] = displayIDs.compactMap { id in
                    ...
                    HStack(spacing: 4) {
                        ...
                        if isMe {
                            Image(systemName: "person.fill")
                                .font(.SmartCityChatSystem(size: 10))
