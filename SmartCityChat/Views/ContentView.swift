...
struct ContentView: View {
    ...
    private var textColor: Color {
        colorScheme == .dark ? Color.teal : Color(red: 0, green: 0.4, blue: 0.5)
    }

    private var secondaryTextColor: Color {
        colorScheme == .dark ? Color.teal.opacity(0.8) : Color(red: 0, green: 0.4, blue: 0.5).opacity(0.8)
    }
...
// MARK: - Body
    ...
    private func messagesView(privatePeer: PeerID?, isAtBottom: Binding<Bool>) -> some View {
        let messages: [SmartCityChatMessage] = {
        ...
        let windowedMessages: [SmartCityChatMessage] = Array(messages.suffix(currentWindowCount))
    ...
    private var inputView: some View {
        VStack(alignment: .leading, spacing: 6) {
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ForEach(Array(viewModel.autocompleteSuggestions.prefix(4)), id: \.self) { suggestion in
                        Button(action: {
                            ...
                            HStack {
                                Text(suggestion)
                                    .font(.SmartCityChatSystem(size: 11, design: .monospaced))
                                    .foregroundColor(textColor)
                                    .fontWeight(.medium)
                                Spacer()
                            }
            ...
            HStack(alignment: .center, spacing: 4) {
                ...
                .font(.SmartCityChatSystem(size: 15, design: .monospaced))
                .foregroundColor(textColor)
    ...
    private func handleOpenURL(_ url: URL) {
        guard url.scheme == "SmartCityChat" else { return }
        switch url.host {
        case "user":
            ...
            VStack(alignment: .leading, spacing: 8) {
                HStack(spacing: 12) {
                    Text(peopleSheetTitle)
                        .font(.SmartCityChatSystem(size: 18, design: .monospaced))
                        .foregroundColor(textColor)
                    Spacer()
                    if case .mesh = locationManager.selectedChannel {
                        Button(action: { showVerifySheet = true }) {
                            Image(systemName: "qrcode")
                                .font(.SmartCityChatSystem(size: 14))
                        }
                        .buttonStyle(.plain)
                        .help(
                    ...
                    Button(action: {
                        ...
                        Image(systemName: "xmark")
                            .font(.SmartCityChatSystem(size: 12, weight: .semibold, design: .monospaced))
                ...
                if let subtitle = peopleSheetSubtitle {
                    ...
                    .font(.SmartCityChatSystem(size: 12, design: .monospaced))
                } else {
                    Text(activeText)
                        .font(.SmartCityChatSystem(size: 12, design: .monospaced))
                        .foregroundColor(.secondary)
                ...
                HStack(spacing: 12) {
                    Button(action: {
                        ...
                        Image(systemName: "chevron.left")
                            .font(.SmartCityChatSystem(size: 12))
                            .foregroundColor(textColor)
        ...
        Button(action: {
            ...
            HStack(spacing: 6) {
                ...
                Text(context.displayName)
                    .font(.SmartCityChatSystem(size: 16, weight: .medium, design: .monospaced))
                    .foregroundColor(textColor)
    ...
    private var mainHeaderView: some View {
        HStack(spacing: 0) {
            Text(verbatim: "SmartCityChat/")
                .font(.SmartCityChatSystem(size: 18, weight: .medium, design: .monospaced))
                .foregroundColor(textColor)
                .onTapGesture(count: 3) {
            ...
            HStack(spacing: 0) {
                Text(verbatim: "@")
                    .font(.SmartCityChatSystem(size: 14, design: .monospaced))
                    ...
                    VStack(spacing: 12) {
                        HStack {
                            Text("content.notes.title")
                                .font(.SmartCityChatSystem(size: 16, weight: .bold, design: .monospaced))
                            Spacer()
                            Button(action: { showLocationNotes = false }) {
                                Image(systemName: "xmark")
                                    .font(.SmartCityChatSystem(size: 13, weight: .semibold, design: .monospaced))
                                    .foregroundColor(textColor)
                                    .frame(width: 32, height: 32)
                            }
                            .buttonStyle(.plain)
...
private extension ContentView {
    func mediaAttachment(for message: SmartCityChatMessage) -> MessageMedia? {
    ...
    func mediaSendState(for message: SmartCityChatMessage, mediaURL: URL) -> (isSending: Bool, progress: Double?, canCancel: Bool) {
        var isSending = false
        var progress: Double?
    ...
    @ViewBuilder
    private func messageRow(for message: SmartCityChatMessage) -> some View {
        if message.sender == "system" {
    ...
    @ViewBuilder
    private func systemMessageRow(_ message: SmartCityChatMessage) -> some View {
    ...
    @ViewBuilder
    private func mediaMessageRow(message: SmartCityChatMessage, media: MessageMedia) -> some View {
    ...
    @ViewBuilder
    private func textMessageRow(_ message: SmartCityChatMessage) -> some View {
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            if isLong && cashuTokens.isEmpty {
                ...
                .font(.SmartCityChatSystem(size: 11, weight: .medium, design: .monospaced))
    ...
    private func expandWindow(ifNeededFor message: SmartCityChatMessage,
                              allMessages: [SmartCityChatMessage],
                              privatePeer: PeerID?,
    ...
    var attachmentButton: some View {
        ...
        Image(systemName: "camera.circle.fill")
            .font(.SmartCityChatSystem(size: 24))
                ...
                HStack {
                    Button(action: { dismiss() }) {
                        Text("close", comment: "Button to dismiss fullscreen media viewer")
                            .font(.SmartCityChatSystem(size: 15, weight: .semibold))
