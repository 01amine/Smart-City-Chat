...
struct GossipSyncManagerTests {
    ...
    @Test func staleAnnouncementsArePurgedWithMessages() throws {
        ...
        let announcePacket = SmartCityChatPacket(
        ...
        let messagePacket = SmartCityChatPacket(
            type: MessageType.message.rawValue,
            senderID: senderData,
            recipientID: nil,
            timestamp: initialTimestampMs,
    ...
    @Test func ignoresAnnounceOlderThanStaleTimeout() throws {
        ...
        let freshMessage = SmartCityChatPacket(
            type: MessageType.message.rawValue,
            senderID: senderData,
            recipientID: nil,
    ...
    @Test func maintenanceEmitsTypedSyncRequests() throws {
        ...
        let filePacket = SmartCityChatPacket(
...
private final class RecordingDelegate: GossipSyncManager.Delegate {
    var onSend: (() -> Void)?
    private(set) var lastPacket: SmartCityChatPacket?
    private(set) var packets: [SmartCityChatPacket] = []
