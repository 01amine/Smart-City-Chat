...
- **File:** `SmartCityChatTests/Mocks/MockBLEService.swift`
...
- **Handlers:** Tests can observe data via `messageDeliveryHandler` (decoded `SmartCityChatMessage`) and `packetDeliveryHandler` (raw `SmartCityChatPacket`).
