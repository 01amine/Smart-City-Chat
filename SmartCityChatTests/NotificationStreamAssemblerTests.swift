...
struct NotificationStreamAssemblerTests {
    private func makePacket(timestamp: UInt64 = 0x0102030405) -> SmartCityChatPacket {
    ...
    func testAssemblesCompressedLargeFrame() throws {
        ...
        let decodedFile = try #require(SmartCityChatFilePacket.decode(decodedPacket.payload), "Failed to decode TLV payload")
