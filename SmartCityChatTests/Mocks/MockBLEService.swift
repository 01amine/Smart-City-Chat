...
final class MockBLEService: NSObject {
    ...
    var sentMessages: [(message: SmartCityChatMessage, packet: SmartCityChatPacket)] = []
    var sentPackets: [SmartCityChatPacket] = []
    var connectedPeers: Set<PeerID> = []
    var messageDeliveryHandler: ((SmartCityChatMessage) -> Void)?
    var packetDeliveryHandler: ((SmartCityChatPacket) -> Void)?
    ...
    func sendFileBroadcast(_ packet: SmartCityChatFilePacket, transferId: String) {
        // Tests currently ignore file transfer flows; keep stub for protocol conformance.
    }

    func sendFilePrivate(_ packet: SmartCityChatFilePacket, to peerID: PeerID, transferId: String) {
        // Tests currently ignore file transfer flows; keep stub for protocol conformance.
    }
    ...
    func simulateIncomingMessage(_ message: SmartCityChatMessage) {
    ...
    func simulateIncomingPacket(_ packet: SmartCityChatPacket) {
        // Process through the actual handling logic
        if let message = SmartCityChatMessage(packet.payload) {
